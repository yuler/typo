...
<template>
  <div
    :class="cn(
      'indicator-capsule h-full w-full flex items-center pl-4 gap-3 transition-shadow duration-300 select-none bg-neutral-800 rounded-lg border border-white/10 overflow-hidden cursor-grab active:cursor-grabbing',
      state === 'processing' && 'indicator-capsule--processing'
    )"
    tabindex="0"
