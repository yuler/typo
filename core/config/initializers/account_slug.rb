module AccountSlug
  ...
  RESERVED_SLUGS = %w[session dashboard onboarding dev admin api assets billing corrections help jobs login logout magic_link rails settings setup static support typo]
