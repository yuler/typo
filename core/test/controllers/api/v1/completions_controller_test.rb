...
class Api::V1::CompletionsControllerTest < ActionDispatch::IntegrationTest
  ...
  #   post api_v1_completions_url, params: { text: "hello", system_prompt: "correct this" }, as: :json
  #   assert_response :success
  #   assert_equal "AI Result: hello", JSON.parse(response.body)["result"]
  # end

  # test "should return unprocessable_entity if text is missing" do
  #   post api_v1_completions_url, params: { system_prompt: "correct this" }, as: :json
  ...
  #   5.times do
  #     post api_v1_completions_url, params: { text: "test" }, as: :json
  #     assert_response :success
  #   end
